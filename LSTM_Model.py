...
class LSTMModel(nn.Module):
    def __init__(self, vocab_size, hidden_size, dropout):
        ...
        self.lstm1 = nn.LSTM(vocab_size, hidden_size, batch_first=True)
    ...
    def forward(self, input, lstm_1_state_h_in=None, lstm_1_state_c_in=None,
        ...
        out, (lstm_1_state_h_out, lstm_1_state_c_out) = self.lstm1(input.float(), (lstm_1_state_h_in, lstm_1_state_c_in))
